  ...
  module Parser
    describe SQLLimitParser do
      ...
      it "should parse LIMIT 10" do
        parse_and_eval("LIMIT 10").should == Expressions::Limit.new(10)
      end
      
      it "should parse LIMIT 20" do
        parse_and_eval("LIMIT 20").should == Expressions::Limit.new(20)
      end
      
      it "should parse LIMIT  30 (with spaces)" do
        parse_and_eval("LIMIT  30").should == Expressions::Limit.new(30)
      end
      ...
      it "should parse LIMIT 0" do
        parse_and_eval("LIMIT 0").should == Expressions::Limit.new(0)
      end
